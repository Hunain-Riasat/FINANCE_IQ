...
/* ── Keep header but make it invisible except the sidebar toggle ── */
...
.sidebar-brand .brand-logo-bg {
  width: 68px; height: 68px;
  background: linear-gradient(145deg, #1a2d4a 0%, #0f1d33 100%);
  border: 1.5px solid rgba(74,144,217,0.35);
  border-radius: 20px;
  display: flex; align-items: center; justify-content: center;
  box-shadow: 0 8px 24px rgba(74,144,217,0.22), 0 2px 8px rgba(0,0,0,0.5);
  position: relative;
  overflow: hidden;
}
.sidebar-brand .brand-logo-bg::before {
  content: '';
  position: absolute;
  top: -1px; left: -1px; right: -1px;
  height: 50%;
  background: linear-gradient(180deg, rgba(74,144,217,0.12), transparent);
...
.sidebar-brand h1 span.highlight {
  background: linear-gradient(90deg, #5ba3e8, #38b2ac);
  ...
  <div class="brand-logo-wrap">
    <div class="brand-logo-bg">
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Chart bars -->
        <rect x="4" y="22" width="6" height="12" rx="2" fill="#4a90d9" opacity="0.85"/>
        <rect x="13" y="15" width="6" height="19" rx="2" fill="#4a90d9"/>
        <rect x="22" y="10" width="6" height="24" rx="2" fill="#38b2ac"/>
        <!-- Trend line -->
        <polyline points="7,21 16,14 25,9 34,5" stroke="#c9a84c" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
        <!-- Dot at peak -->
        <circle cx="34" cy="5" r="2.8" fill="#c9a84c"/>
        <!-- Right bar -->
        <rect x="31" y="18" width="6" height="16" rx="2" fill="#38b2ac" opacity="0.7"/>
        <!-- Base line -->
        <line x1="3" y1="35" x2="37" y2="35" stroke="rgba(255,255,255,0.18)" stroke-width="1.5" stroke-linecap="round"/>
      </svg>
    </div>
  </div>
...
">
  ...
  ">
    Made with <span style="color:#e05c6a;font-size:13px;">&#9829;</span> by
    <div style="margin-top:6px;display:flex;flex-direction:column;gap:3px;">
      <span style="background:linear-gradient(90deg,#4a90d9,#38b2ac);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-weight:700;font-size:12.5px;">Zain, Hunain & Shaheer</span>
      <!--
      <span style="background:linear-gradient(90deg,#38b2ac,#c9a84c);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-weight:700;font-size:12.5px;">Shaheer</span>
      -->
        </div>
  </div>
</div>
